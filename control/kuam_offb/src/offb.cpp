...
bool Offboard::GetParam()
{
    ...
    m_nh.getParam(node_name_with_namespace+ "/setpoint_pub_interval", m_setpoint_pub_interval_param);
    m_nh.getParam(node_name_with_namespace+ "/is_debug_mode", m_is_debug_mode_param);
...
bool Offboard::InitROS()
{
    ...
    m_target_waypoints_sub = m_nh.subscribe<uav_msgs::TargetWaypoints>
            ("/control/generate_waypoints/target_waypoints", 10, boost::bind(&Offboard::TargetWaypointsCallback, this, _1));
    m_command_sub = 
        m_nh.subscribe<uav_msgs::Chat>("/control/chat/command", 10, boost::bind(&Offboard::ChatterCallback, this, _1));
