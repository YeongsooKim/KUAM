#include "kuam_ctrl_visual/visualize_control.h"
#include <cmath>
...
void VisualizeControl::InitROS()
{
    ...
    // subscriber init
    m_ego_state_sub = m_nh.subscribe<uav_msgs::VehicleState>("/control/generate_waypoints/ego_state", 10, boost::bind(&VisualizeControl::EgoVehicleStateCallback, this, _1)); 
    m_target_state_sub = m_nh.subscribe<uav_msgs::VehicleStateArray>("/control/generate_waypoints/target_states", 10, boost::bind(&VisualizeControl::TargetVehicleStatesCallback, this, _1)); 
    m_target_waypoints_sub = m_nh.subscribe<uav_msgs::TargetWaypoints>("/control/generate_waypoints/target_waypoints", 1, boost::bind(&VisualizeControl::WaypointsCallback, this, _1));
