#ifndef __STATE_MACHINE_UTILS_H__
#define __STATE_MACHINE_UTILS_H__
...
public:
    ...
    Eigen::Vector3d BodyRads2EnuRads(kuam::Euler euler, Eigen::Vector3d body_rads);
...
#endif // __STATE_MACHINE_UTILS_H__