...
sudo apt-get -y --quiet install ros-melodic-mavros ros-melodic-mavros-extras

sudo apt-get -y --quiet install python-catkin-tools python-rosinstall-generator -y
...
sudo rosinstall_generator --rosdistro melodic mavlink | tee /tmp/mavros.rosinstall

## Build MAVROS
### Get source (upstream - released)
sudo rosinstall_generator --rosdistro melodic --upstream mavros | tee -a /tmp/mavros.rosinstall
